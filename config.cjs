...
const config = {
  SESSION_ID: process.env.SESSION_ID || "MALVIN-MD&U3EQUu17",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "✪⏤͟͞★⃝ꪶ‎Tristan𖥘✪͜͡➺",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "27656319889",
